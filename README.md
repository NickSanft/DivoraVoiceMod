...
- **The Coven — 16 bundled persona presets.** A browsable cast of character voices: Hollow King, Velvet Demon, Static Wraith, The Oracle, Choir of Ash, Seraph, Dirge, The Swarm, The Possessed, Leviathan, The Imp, Dispatch, Corrupted, Whisper Wraith, Deep Narrator (AI), Zombie, Enderman, Ghast, and Clean Passthrough. Plus unlimited user presets with a full JSON editor, export/import, and **A/B compare** on the Mixer.
