...
```
gate · denoiser · pitch · formant · eq · robot · distortion · echo · reverb · chorus · harmonizer · compressor · deesser · radio_bandpass · vintage_noise · tremolo · voice_convert
```

(`chorus` added in v1.2.0, `harmonizer` in v1.2.1, `compressor` + `deesser` in v1.8.0, `radio_bandpass` + `vintage_noise` in v1.32.0, `tremolo` in v1.34.0 — kinds are additive after v1.0.)
