...
**Next up:** the v1.8–v1.10 roadmap is shipped (dynamics, control surfaces, guided mic calibration), plus light theme (v1.11) and the update check + E2E harness (v1.12). Shipped v1.13 setup diagnostic and v1.14 quick wins (preset import, logs/report affordance, README roadmap). Now in the **standout features** track: v1.15 custom glyph casting (shipped); **v1.16 spell-circle stream overlay** in flight. Further work follows standard semver — see "Further out" below.
