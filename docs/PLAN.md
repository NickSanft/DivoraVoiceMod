...
| post-1.0 ⋯ | next | **Accent-preserving cloning (research)**: explore a zero-shot engine that carries accent/prosody, not just timbre (see Deferred below). | A clone keeps the speaker's accent. |
