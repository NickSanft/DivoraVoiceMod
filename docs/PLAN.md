...
| post-1.0 ⋯ | next | **Improve voice cloning (cont.)**: auto-pick the Kokoro base by gender/accent per cloned voice; optional in-app dry-mic recording; explore an accent-preserving zero-shot engine. | A cloned voice matches gender/accent better; record without an external clip. |
