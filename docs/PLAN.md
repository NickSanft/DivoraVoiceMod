...
**Next up:** the v1.8–v1.10 roadmap is shipped (dynamics, control surfaces, guided mic calibration), plus light theme (v1.11) and the update check + E2E harness (v1.12). Shipped v1.13 setup diagnostic and v1.14 quick wins (preset import, logs/report affordance, README roadmap). The post-v1.11 follow-up batch is complete. Further work follows standard semver — see "Further out" below.
