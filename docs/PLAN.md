...
**Next up:** the v1.8–v1.10 roadmap is shipped (dynamics, control surfaces, guided mic calibration), plus light theme (v1.11) and the update check + E2E harness (v1.12). Shipped v1.13 setup diagnostic ("Test my setup"). In flight: **v1.14 quick wins** (preset import, logs/report affordance, README roadmap). Further work follows standard semver — see "Further out" below.
