...
| post-1.0 ⋯ | next | **Improve voice cloning (cont.)**: optional in-app dry-mic recording (clone without an external clip); explore an accent-preserving zero-shot engine. | Record a reference in-app; accent eventually preserved. |
