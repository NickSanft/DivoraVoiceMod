...
| post-1.0 ⋯ | next | **Improve voice cloning**: auto-pick the Kokoro base by gender/accent per cloned voice; shrink the 157 MB converter (on-demand download or quantization); optional in-app dry-mic recording; explore an accent-preserving zero-shot engine. | A cloned voice matches gender/accent better; smaller install. |
